...
class PopularRestaurants extends Component {
  ...
  onChangeFilterRestaurants = event => {
    // const {searchRestaurant} = this.state
  ...
  renderPopularRestaurants = () => {
    ...
    const searchFilterRestaurant = restaurantsList.filter(eachItems =>
      eachItems.name.toLowerCase().includes(searchRestaurant.toLowerCase()),
    )
    return (
      <>
        <RestaurantsHeader
        ...
        <div className="search-container">
          ...
          <input
            ...
            onChange={this.onChangeFilterRestaurants}
          />
        </div>

        <ul className="restaurants-list">
          {searchFilterRestaurant.map(eachItem => (
